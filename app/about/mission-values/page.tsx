      ...
      <section className="relative pt-32 pb-32 bg-[#8b6b7b] overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 sm:px-12 md:px-16 lg:px-20 xl:px-24 relative z-10">
          <div className="text-center mt-20">
            <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight px-4 ${isRTL ? 'font-arabic' : 'font-english'}`} style={{ fontFamily: isRTL ? 'GESSTwo, Arial, sans-serif' : 'Poppins, Arial, sans-serif' }}>
              {t('missionValues.hero.title')}
            </h1>
            <p className={`text-lg sm:text-xl md:text-2xl text-white leading-relaxed max-w-3xl mx-auto px-4 ${isRTL ? 'font-arabic' : 'font-english'}`} style={{ fontFamily: isRTL ? 'GESSTwo, Arial, sans-serif' : 'Poppins, Arial, sans-serif' }}>
          ...
          <div>
            <div className={`grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-16 ${isRTL ? 'lg:grid-flow-col-dense' : ''}`}>
              ...
              <div className={`flex justify-center ${isRTL ? 'lg:col-start-1' : ''}`}>
                <div className={`relative w-full max-w-2xl h-[420px] lg:h-[550px] ${isRTL ? 'mr-4' : 'ml-4'}`}>
                  <Image
                    src="/images/1.jpg"
              ...
              {[
                ...
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 text-white border border-white/20 h-24 sm:h-28 flex items-center">
                  <div className={`flex items-center ${isRTL ? 'space-x-reverse' : 'space-x-3'} sm:${isRTL ? 'space-x-reverse' : 'space-x-4'} w-full`}>
                    ...
                    <p className={`text-xs sm:text-sm leading-relaxed mr-2 flex-1 ${isRTL ? 'font-arabic' : 'font-english'}`} style={{ fontFamily: isRTL ? 'GESSTwo, Arial, sans-serif' : 'Poppins, Arial, sans-serif' }}>{operation}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div>
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center ${isRTL ? 'lg:grid-flow-col-dense' : ''}`}>
              <div className={`flex justify-center ${isRTL ? 'lg:justify-end lg:col-start-2' : 'lg:justify-start'}`}>
                <div className={`relative w-full max-w-2xl h-[500px] lg:h-[730px] ${isRTL ? 'mr-4' : 'ml-4'}`}>
                  <Image
                    src="/images/3.jpg"
